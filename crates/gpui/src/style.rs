...
impl From<AlignItems> for taffy::style::AlignItems {
    fn from(value: AlignItems) -> Self {
        // taffy 0.12 turned AlignItems into a struct with keyword + safety
        // consts; gpui's enum maps onto the "unsafe" (CSS default) variants.
        match value {
...
impl From<AlignContent> for taffy::style::AlignContent {
    fn from(value: AlignContent) -> Self {
        // See the AlignItems mapping above: taffy 0.12 uses keyword consts.
        match value {
